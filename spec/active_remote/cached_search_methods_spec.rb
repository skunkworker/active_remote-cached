...
describe SearchMethodClass do
  ...
  describe "#cached_search_by_guid" do
    ...
    it "merges the default options in for the fetch call" do
      ::ActiveRemote::Cached.cache.expects(:fetch).with([RUBY_AND_ACTIVE_SUPPORT_VERSION, SearchMethodClass.name, "#search", "guid"], :expires_in => 100).returns(:hello)
    ...
    it "overrides the default options with local options for the fetch call" do
      ::ActiveRemote::Cached.cache.expects(:fetch).with([RUBY_AND_ACTIVE_SUPPORT_VERSION, SearchMethodClass.name, "#search", "guid"], :expires_in => 200).returns(:hello)
    ...
    describe "namespaced cache" do
      ...
      it "uses the namespace as a prefix to the cache key" do
        ::ActiveRemote::Cached.cache.expects(:fetch).with([RUBY_AND_ACTIVE_SUPPORT_VERSION, "MyApp", SearchMethodClass.name, "#search", "guid"], :expires_in => 100).returns(:hello)
  ...
  describe "#cached_search_by_foo" do
    ...
    it "overrides the default options with cached_finder options for the fetch call" do
      ::ActiveRemote::Cached.cache.expects(:fetch).with([RUBY_AND_ACTIVE_SUPPORT_VERSION, SearchMethodClass.name, "#search", "foo"], :expires_in => 500).returns(:hello)
    ...
    it "overrides the cached_finder options with local options for the fetch call" do
      ::ActiveRemote::Cached.cache.expects(:fetch).with([RUBY_AND_ACTIVE_SUPPORT_VERSION, SearchMethodClass.name, "#search", "foo"], :expires_in => 200).returns(:hello)
